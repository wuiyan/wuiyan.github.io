import{_ as e,Y as n,Z as a,a4 as s}from"./framework-646c68e2.js";const i={},l=s(`<h5 id="启动-关闭-重启防火墙" tabindex="-1"><a class="header-anchor" href="#启动-关闭-重启防火墙" aria-hidden="true">#</a> 启动|关闭|重启防火墙</h5><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl status firewalld.service
